   ...
   // console.log(createDiv.id)
    ...
    // if(createBtn){
       switch (createBtn){  
        ...
        const prodSelecId = createBtn;
      products.innerHTML +=
      `<div> 
      <li><input type="checkbox"/> <p> ${objproducto.datos.Nombre} de ${ele} ${objproducto.datos.Precio} <a id=""><img src="./image/delete-button.png"/></a></li> 
      </div>`;  
      array1.push(prodSelecId);
